...
public class Croptop extends Item {
    ...
    public Croptop(int Id, String Seller_Name, String Note, int Quantity, java.util.Date Date, int GSM_Index, String color, String fabric_Met, String size) {
